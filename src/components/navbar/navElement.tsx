...
export default function NavElement(props: { text: string, linksTo: string}) {
  return (
    <li>
      <a href={props.linksTo} className="flex place-items-center hover:">
        <h1 className="text-tausta text-[19px] hover:text-mannynvihrea duration-100">
          {
            props.text
          }
        </h1>
        <svg viewBox="0 0 330 512" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="1.3em" height="1.3em" fill="white" className="">
