    ...
    <header>
      <div className="h-[120px] bg-partionsininen py-[20px] px-[40px] flex ">
        ...
        <nav className="md:hidden place-items-center flex">
          <button onClick={() => {setMobileNav(!mobileNav); setCloseMenuButton(!closeMenuButton)}} className="w-[19px]">
            <span className="flex">
              <div hidden={closeMenuButton}>
                <svg viewBox="0 0 512 512" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="1.3em" height="1.3em" fill="white">
...
<img width="30px"
     src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/1c/Octicons-three-bars.svg/1200px-Octicons-three-bars.svg.png"/>