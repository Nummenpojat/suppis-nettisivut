  ...
  return (
    <div className="w-screen h-[calc(100vh-120px)]">
      <section className="h-full flex place-content-center">
        <form className="m-5 flex flex-col w-1/4" onSubmit={handleSubmit}>
          <h1 className="text-[35px]">Lähetä viesti</h1>
          <label>Viesti:</label>
          <textarea rows={3}
                    onChange={(event) => {
          ...
          <label>
            <input type="checkbox" className="m-3 checked:accent-mannynvihrea" checked={oneOrList}
          ...
          </label>
          {
            oneOrList ?
              <div>
                <label>
                  Mille ikäkausille lähetetään viesti
                </label><br/>
                <ul>
